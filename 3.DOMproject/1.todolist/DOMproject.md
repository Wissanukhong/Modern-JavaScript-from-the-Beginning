...
2. จากนั้นเราก็เขียน function เพื่อเรียกใช้งาน แบบ callback function
...
```
3.  หลังจากที่เราเขียน function ด้านบนแล้ว เราจะต้องมาเขียน function ที่เราเรียกใช้ก่อนหน้านี้
